...
public class BillingReportView {
    ...
    private static void printMenu() {
        ...
        System.out.println(BOLD_YELLOW + "║" + BOLD_WHITE + "  2. " + WHITE
                + "Xem chi tiết hóa đơn                              " + BOLD_YELLOW + "║" + RESET);
        System.out.println(BOLD_YELLOW + "║" + BOLD_WHITE + "  3. " + WHITE
                + "Ghi nhận thanh toán                               " + BOLD_YELLOW + "║" + RESET);
        System.out.println(BOLD_YELLOW + "║                                                       ║" + RESET);
        ...
        System.out.println(BOLD_YELLOW + "║" + BOLD_WHITE + "  7. " + WHITE
                + "Thống kê đơn giao thành công                      " + BOLD_YELLOW + "║" + RESET);
        System.out.println(BOLD_YELLOW + "║                                                       ║" + RESET);
        System.out.println(BOLD_YELLOW + "║" + BOLD_CYAN + "  [QUẢN LÝ DỮ LIỆU - CRUD]                             "
                + BOLD_YELLOW + "║" + RESET);
    ...
    private static void handleAddInvoice() {
        ...
        // Cho phép nhấn Enter để sinh mã tự động
        ...
        // Bắt buộc lấy mã đơn hàng đã giao để tính phí tự động
        ...
        if (BillingReportService.invoiceExistsForOrder(orderId)) {
            Invoice existing = BillingReportService.findInvoiceByOrderId(orderId);
            System.out
                    .println(BOLD_YELLOW + "⚠  Đơn hàng '" + orderId + "' đã có hóa đơn: " + existing.getId() + RESET);
            printInvoiceDetail(existing);
            InputHelper.pressEnterToContinue();
            return;
        }

        // Phí được tính TỰ ĐỘNG từ hệ thống
